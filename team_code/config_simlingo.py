...
class GlobalConfig:
    def __init__(self):
        ...
        self.use_cot = _env_flag("SIMLINGO_USE_COT", True)
        self.use_coop_info = _env_flag("SIMLINGO_USE_COOP_INFO", True)
        self.coop_prompt_mode = os.environ.get("SIMLINGO_COOP_PROMPT_MODE", "state_traj")
        self.coop_future_source = "constant_velocity"
        self.coop_actor_radius = _env_float("SIMLINGO_COOP_ACTOR_RADIUS", 40.0)
        self.coop_max_actors = _env_int("SIMLINGO_COOP_MAX_ACTORS", 6)
        self.coop_future_horizon = 10
        self.coop_future_dt = 0.2
        self.coop_include_types = _env_list("SIMLINGO_COOP_INCLUDE_TYPES", ["car", "walker"])
